                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-form-item prop="videoSize">
                                <div v-if="scope.row.videoPath">已有视频</div>
                                <upVideo v-else ref="upVideo" :videoName="it.videoName" :index="index" :id="id"  @success="getVideoPath" @changeVideo="changeVideo"></upVideo>
                            </el-form-item>
                        </template>
                    </el-table-column>
                    <el-table-column
